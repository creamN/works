$(function(){
    ...
    $("a.arrL").mouseover(function(){stopFocusAm();}).mouseout(function(){starFocustAm();}).click(function(){prePage()});
    $("a.arrR").mouseover(function(){stopFocusAm();}).mouseout(function(){starFocustAm();}).click(function(){nextPage()});
