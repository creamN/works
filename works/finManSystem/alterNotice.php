        ...
        <form name="form" method="post" action="doAdminAction.php?act=noticeAlter&id=<?php echo $id;?>" enctype="multipart/form-data">
            <table class="table" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="td1"><input name="title" class="inputTxt" type="text" value="<?php echo $rows['title'];?>"/></td>
                    <td rowspan="6">
                        <div class="proPic">
                ...
                <tr>
                    <th>发布时间</th>
                    <td class="td1"><input name="addTime" class="inputTxt" type="text" value="<?php echo $rows['addTime'];?>"/></td>
                </tr>                
                <tr>
                    <th>通知概述</th>
